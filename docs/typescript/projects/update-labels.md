...
| `labels` | `string[]` | ✅ | Array of project labels. Replaces the previous labels. Maximum of 1000 labels are allowed, each up to 36 alphanumeric characters long. |
...
const result: Models.Project = await projects.updateLabels({
