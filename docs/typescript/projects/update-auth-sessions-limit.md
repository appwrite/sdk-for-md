...
| `limit` | `number` | ✅ | Set the max number of users allowed in this project. Value allowed is between 1-100. Default is 10 |
...
const result: Models.Project = await projects.updateAuthSessionsLimit({
