...
const result: Models.ScheduleList = await projects.listSchedules({
...
Returns a `Models.ScheduleList` object with the following properties:

| Property | Type | Description |
|----------|------|-------------|
| `total` | `number` | Total number of schedules that matched your query. |
| `schedules` | `object[]` | List of schedules. |
