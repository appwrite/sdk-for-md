...
| `numbers` | `object[]` | ✅ | An array of mock numbers and their corresponding verification codes (OTPs). Each number should be a valid E.164 formatted phone number. Maximum of 10 numbers are allowed. |
...
const result: Models.Project = await projects.updateMockNumbers({
