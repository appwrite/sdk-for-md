...
| `useCases` | `UseCases` | ❌ | List of use cases allowed for filtering function templates. Maximum of 100 use cases are allowed. (Default: `[]`)<br>**Allowed:** `dev-tools`, `starter`, `databases`, `ai`, `messaging`, `utilities` |
