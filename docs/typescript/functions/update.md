...
| `buildSpecification` | `string` | ❌ | Build specification for the function deployments. (Default: `[]`) |
| `runtimeSpecification` | `string` | ❌ | Runtime specification for the function executions. (Default: `[]`) |
