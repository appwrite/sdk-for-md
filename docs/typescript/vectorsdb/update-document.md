...
| `data` | `object` | ❌ | Document data as JSON object. Include only fields and value pairs to be updated. (Default: `{}`) |
...
const result: Models.Document = await vectorsDB.updateDocument({
