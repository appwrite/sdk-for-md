...
⚠️ **DEPRECATED** since 1.8.0 - Use `tablesDB.createIpColumn` instead
...
const result: Models.AttributeIp = await databases.createIpAttribute({
...
Returns a `Models.AttributeIp` object with the following properties:
