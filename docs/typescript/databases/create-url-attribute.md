...
⚠️ **DEPRECATED** since 1.8.0 - Use `tablesDB.createUrlColumn` instead
...
const result: Models.AttributeUrl = await databases.createUrlAttribute({
...
Returns a `Models.AttributeUrl` object with the following properties:
