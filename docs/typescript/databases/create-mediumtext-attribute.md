...
const result: Models.AttributeMediumtext = await databases.createMediumtextAttribute({
...
Returns a `Models.AttributeMediumtext` object with the following properties:
