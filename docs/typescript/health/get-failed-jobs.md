...
|-----------|------|----------|-------------|
| `name` | `Name` | ✅ | The name of the queue<br>**Allowed:** `v1-database`, `v1-deletes`, `v1-audits`, `v1-mails`, `v1-functions`, `v1-stats-resources`, `v1-stats-usage`, `v1-webhooks`, `v1-certificates`, `v1-builds`, `v1-screenshots`, `v1-messaging`, `v1-migrations` |
