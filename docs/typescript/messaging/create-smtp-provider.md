...
| `port` | `number` | ❌ | The default SMTP server port. (Default: `587`) |
| `username` | `string` | ❌ | Authentication username. |
| `password` | `string` | ❌ | Authentication password. |
| `encryption` | `SmtpEncryption` | ❌ | Encryption type. Can be omitted, &#039;ssl&#039;, or &#039;tls&#039;<br>**Allowed:** `none`, `ssl`, `tls` |
| `autoTLS` | `boolean` | ❌ | Enable SMTP AutoTLS feature. (Default: `1`) |
...
const result: Models.Provider = await messaging.createSMTPProvider({
