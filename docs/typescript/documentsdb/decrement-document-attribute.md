...
| `value` | `number` | ❌ | Value to decrement the attribute by. The value must be a number. (Default: `1`) |
...
const result: Models.Document = await documentsDB.decrementDocumentAttribute({
