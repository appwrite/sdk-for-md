...
const result: Models.ProviderList = await messaging.listProviders({
  queries: [],
  search: '<SEARCH>',
  total: false,
});
...
Returns a `Models.ProviderList` object with the following properties:

| Property | Type | Description |
|----------|------|-------------|
| `total` | `number` | Total number of providers that matched your query. |
| `providers` | `object[]` | List of providers. |
