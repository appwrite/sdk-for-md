...
⚠️ **DEPRECATED** since 1.8.0 - Use `tablesDB.updateEnumColumn` instead
...
| `elements` | `string[]` | ✅ | Updated list of enum values. |
...
const result: Models.AttributeEnum = await databases.updateEnumAttribute({
