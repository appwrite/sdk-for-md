...
| `secret` | `boolean` | ❌ | Secret variables can be updated or deleted, but only functions can read them during build and runtime. (Default: `1`) |
...
const result: Models.Variable = await functions.createVariable({
